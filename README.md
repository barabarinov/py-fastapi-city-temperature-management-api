...
The “City-Temperature-Management-API” is a project built using FastAPI. It provides functionalities related to managing cities and temperature records.

### Installation from GitHub
```shell
git clone https://github.com/barabarinov/py-fastapi-city-temperature-management-api.git
python -m venv venv
```
...
Create an .env file and define API_KEY (use your own from [weatherapi.com](https://www.weatherapi.com)) using .env.example.

Use once next command to initialize new configurations and directory structure for migrations:
```shell
alembic init alembic
```

This project uses Alembic for managing database migrations. Run next commands to create and run migration:
```shell
...
### Endpoints:
Use ```/docs``` endpoint to interact with API
### City App:
* ```GET /cities```: Get a list of all cities.
* ```POST /cities```: Create a new city.
